...
class demogCombo : public demogData {
  public:
    ...
    demogData(in->getName(),in->getStateName(),in->getpopOver65(),in->getpopUnder18(),in->getpopUnder5(),in->getBAup(),in->getHSup(),in->getPoverty(),in->getPop(),in->getrace()), count_num(1) {}
    //getter
